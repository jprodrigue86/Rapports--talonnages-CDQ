...
class PackagedWebAssetsTest {
    ...
    @Test fun `startup and images are supplied from installed assets`() {
        val loader = loader()
        assertEquals("/Rapports--talonnages-CDQ/native/v25.40/", PackagedWebAssets.PREFIX)
        assertEquals(
            "https://jprodrigue86.github.io/Rapports--talonnages-CDQ/native/v25.40/index.html",
            PackagedWebAssets.START_URL
        )
        ...
        val sprite = loader.intercept(Uri.parse(
            "https://${PackagedWebAssets.HOST}${PackagedWebAssets.PREFIX}bundles/balance-cdq/v25.15/icons-transparent.webp"
        ))!!
        ...
        val reference = loader.intercept(Uri.parse(
            "https://${PackagedWebAssets.HOST}${PackagedWebAssets.PREFIX}bundles/balance-cdq/v25.14/icons-reference.png"
        ))!!
        ...
        val pdfLib = loader.intercept(Uri.parse(
            "https://${PackagedWebAssets.HOST}${PackagedWebAssets.PREFIX}vendor/pdf-lib-1.17.1.min.js"
        ))!!
