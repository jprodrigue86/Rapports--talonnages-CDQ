...
try{
  ...
  page.on('request',async request=>{
    ...
    if(url.includes('/bundles/balance-cdq/latest/manifest.json')||url.includes('/version.json'))return request.respond({status:200,contentType:'application/json',body:JSON.stringify({version:'V25.31',build:'2026.09.26-v25.48-keyboard-copy-flow'})});
  ...
  // V25.48: Android settings must compare the installed APK against the
