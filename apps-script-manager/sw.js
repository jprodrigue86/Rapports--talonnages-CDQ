const CACHE='cdq-apps-script-manager-v35-mobile-fidelity';
const ASSETS=['./','index.html','style.css?v=35','api.js?v=23','jszip.min.js?v=23','app.js?v=35','manifest.webmanifest','icon-industrial.svg','icon-192.png','icon-512.png'];
