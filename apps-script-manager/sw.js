const CACHE='cdq-apps-script-manager-v12';
const ASSETS=['./','index.html','style.css?v=12','api.js?v=12','jszip.min.js?v=12','app.js?v=12','manifest.webmanifest','icon-192.png','icon-512.png'];
