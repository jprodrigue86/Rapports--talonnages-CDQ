const CACHE='cdq-apps-script-manager-v39-resilient-google-api';
const ASSETS=['./','index.html','style.css?v=39','api.js?v=39','jszip.min.js?v=23','app.js?v=39','manifest.webmanifest','icon-industrial.svg','icon-192.png','icon-512.png'];
