const CACHE='cdq-apps-script-manager-v33-write-progress';
const ASSETS=['./','index.html','style.css?v=33','api.js?v=23','jszip.min.js?v=23','app.js?v=33','manifest.webmanifest','icon-192.png','icon-512.png'];
