const CACHE='cdq-apps-script-manager-v28-resilient-bundles';
const ASSETS=['./','index.html','style.css?v=23','api.js?v=23','jszip.min.js?v=23','app.js?v=28','manifest.webmanifest','icon-192.png','icon-512.png'];
