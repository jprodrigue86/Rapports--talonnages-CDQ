const CACHE='cdq-apps-script-manager-v13';
const ASSETS=['./','index.html','style.css?v=13','api.js?v=13','jszip.min.js?v=13','app.js?v=13','manifest.webmanifest','icon-192.png','icon-512.png'];
