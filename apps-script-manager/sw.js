const CACHE='cdq-apps-script-manager-v30-no-auto-rollback';
const ASSETS=['./','index.html','style.css?v=23','api.js?v=23','jszip.min.js?v=23','app.js?v=30','manifest.webmanifest','icon-192.png','icon-512.png'];
