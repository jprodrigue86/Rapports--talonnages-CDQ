const CACHE='cdq-apps-script-manager-v17';
const ASSETS=['./','index.html','style.css?v=17','api.js?v=17','jszip.min.js?v=17','app.js?v=17','manifest.webmanifest','icon-192.png','icon-512.png'];
