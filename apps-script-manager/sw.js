const CACHE='cdq-apps-script-manager-v34-industrial-ui';
const ASSETS=['./','index.html','style.css?v=34','api.js?v=23','jszip.min.js?v=23','app.js?v=34','manifest.webmanifest','icon-industrial.svg','icon-192.png','icon-512.png'];
