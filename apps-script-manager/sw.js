const CACHE='cdq-apps-script-manager-v40-guarded-model-cleanup';
const ASSETS=['./','index.html','style.css?v=40','api.js?v=40','jszip.min.js?v=23','app.js?v=40','manifest.webmanifest','icon-industrial.svg','icon-192.png','icon-512.png'];
