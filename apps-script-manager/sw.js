const CACHE='cdq-apps-script-manager-v36-exact-industrial-ui';
const ASSETS=['./','index.html','style.css?v=36','api.js?v=23','jszip.min.js?v=23','app.js?v=36','manifest.webmanifest','icon-industrial.svg','icon-192.png','icon-512.png'];
