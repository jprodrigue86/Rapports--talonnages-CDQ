const CACHE='cdq-apps-script-manager-v14';
const ASSETS=['./','index.html','style.css?v=14','api.js?v=14','jszip.min.js?v=14','app.js?v=14','manifest.webmanifest','icon-192.png','icon-512.png'];
