const CACHE='cdq-apps-script-manager-v25-direct-patches';
const ASSETS=['./','index.html','style.css?v=23','api.js?v=23','jszip.min.js?v=23','app.js?v=23','manifest.webmanifest','icon-192.png','icon-512.png'];
