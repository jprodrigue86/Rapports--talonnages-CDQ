...
const CACHE = 'cdq-installable-v22-46-plancher-hq';
const FORCE_BUILD='2026.09.19-v22.46-plancher-hq';
const SCOPE = new URL(self.registration.scope);
const APP_SHELL = [
  './offline-templates.mjs?v=22.46', './', './index.html', './reader.html', './reader.mjs?v=21.33', './reader-interactions.mjs?v=21.33', './manifest.webmanifest', './version.json', './firebase-config.js', './google-auth-config.js',
...
function shellKey(url) {
  ...
  if (url.pathname === SCOPE.pathname + 'offline-templates.mjs')
    return new URL('offline-templates.mjs?v=22.46', SCOPE).href;
