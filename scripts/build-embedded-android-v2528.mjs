...
import {applyFastStartupShell2537,applyFastStartupSelector2537} from './fast-start-v2537.mjs';
...
shell=applyFastStartupShell2537(shell);
...
selector=applyFastStartupSelector2537(selector);
