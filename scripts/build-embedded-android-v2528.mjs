...
const local=base+'native/v25.49/';
const build='2026.09.26-v25.49-reader-keyboard-space';
...
files.set('copy-refresh-v2548.js',fs.readFileSync(source+'copy-refresh-v2548.js'));
...
const manifest={version:'25.49',build,files:{}};
