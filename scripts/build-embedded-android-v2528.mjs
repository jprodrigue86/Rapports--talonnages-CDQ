...
import {applyButtonLabelFit2534} from './button-label-fit-v2534.mjs';
...
const local=base+'native/v25.34/';
const build='2026.09.25-v25.34-mots-entiers';
...
selector=applyButtonLabelFit2534(selector);
...
const manifest={version:'25.34',build,files:{}};
