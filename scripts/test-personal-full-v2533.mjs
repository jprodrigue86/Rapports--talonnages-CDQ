...
const anchor='  // V25.47 returning startup: Android already owns the biometric prompt and'
...
// The personal-sizing harness is about geometry/preferences. The real V25.47 browser
