...
function cdq23ParseSheet_(rows){
 ...
 // Raw weight readings only: the legacy Charge utilisée column is intentionally ignored.
 for(var n=1;n<=6;n++){numeric('charge_point_'+n+'_charge_utilisee',at(r+n,5));numeric('charge_point_'+n+'_avant_correction',at(r+n,43));numeric('charge_point_'+n+'_apres_correction',at(r+n,81));}
