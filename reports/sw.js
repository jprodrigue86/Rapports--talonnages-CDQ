...
const CACHE='cdq-reports-independent-v21-88';
const FORCE_BUILD='2026.09.18-v21.88-independent-apps';
...
const APP_SHELL=[
  ...
  root('offline-templates.mjs?v=21.39'),
  ...
  root('assets/music-wall-choice1.webp?v=20260917-fit70')
];
